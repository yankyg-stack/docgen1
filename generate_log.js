...
// ── main generator ───────────────────────────────────────────────────
async function generateLog(staffName, startDate, endDate, outputPath) {
  ...
  const dataRows = rows.map(r =>
    new TableRow({
      ...
      children: [
        ...
        dataCell(["Joel Posen", "BS/SC Supervisor"], colWidths[1]),
        dataCell(["Joel Posen", "BS/SC", "Supervisor"], colWidths[2]),
      ...
      children: [
        ...
        new Paragraph({
          ...
          children: [new TextRun({
            ...
            text: "Attentive Care Service Coordination"
          })]
        }),
      ]
    }]
...
if (require.main === module) {
  ...
  generateLog(staffName, startDate, endDate, `${outDir}/${safeName}_Training_Log.docx`)
    .then(rows => {
