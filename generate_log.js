...
if (require.main === module) {
  ...
  // Sanitize: treat "null", "undefined" as empty
  const cleanEnd  = (!endDate || endDate === "null" || endDate === "undefined") ? "" : endDate;
  ...
  generateLog(staffName, startDate, cleanEnd, `${outDir}/${safeName}_Training_Log.docx`, agency)
    .then(rows => {
