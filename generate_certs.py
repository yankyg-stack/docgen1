...
def create_overlay(staff_name, completion_date, sig_date, agency="Attentive"):
    ...
    # ── Completion date — centered below "Completion Date: ___" line
    # Underline at y ratio 0.329, place date below at ~0.285
    c.setFont("Times-Bold", 12)
    c.setFillColor(HexColor("#000000"))
    c.drawCentredString(pw * 0.565, ph * 0.280, completion_date)

    # ── Signature date — under "Date" label at bottom right
    # "Date" label at x≈0.86 y ratio 0.211, sig date above at ~0.225
    c.setFont("Times-Roman", 11)
    c.drawCentredString(pw * 0.83, ph * 0.225, sig_date)
